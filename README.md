...
기능적 요구사항
1. 고객이 창고에 보관할 제품과 수량을 배달 요청 한다.
2. 고객이 요청한 제품과 수량이 창고에 입고 된다.
3. 창고에 입고된 제품은 창고가 관리 한다.
4. 창고에서 출고를 원하는 경우 출고 한다.
5. 창고에서 폐기해야 할 물건은 폐기 한다.
6. 창고 제품의 상태 및 수량이 바뀔 때 마다 카톡으로 알림을 보낸다.

비기능적 요구사항
1. 트랜잭션
    1. 창고에 배달된 제품관 수량은 창고 현황과 일치 해야 한다. Sync 호출 
2. 성능
    1. 창고의 제품 상태과 수량을 카톡으로 알림을 줄 수 있어야 한다.

# 이벤트스토밍

![이미지 8](https://user-images.githubusercontent.com/63028464/80048652-c5745b80-854b-11ea-9d8d-b18542ede16b.png)

## 헥사고날 아키텍처 다이어그램 도출

![이미지 7](https://user-images.githubusercontent.com/63028464/80048725-f2287300-854b-11ea-97d2-cae8d2032a0f.png)
...
```
- 적용 후 REST API 의 테스트
![이미지 5](https://user-images.githubusercontent.com/63028464/80049636-6532e900-854e-11ea-8e15-3b996429daff.png)
...
- 창고의 제품 상태와 수량이 변경되면 비동기식 호출 처리한다.
